...
constexpr std::uint64_t MSTATUS_UXL_MASK = 0b11ULL << 32;
constexpr std::uint64_t MSTATUS_UXL_RV64 = 0b10ULL << 32;

constexpr std::uint64_t MSTATUS_FS_MASK = 0b11ULL << 13;
constexpr std::uint64_t MSTATUS_FS_INITIAL = 0b01ULL << 13;
constexpr std::uint64_t MSTATUS_FS_DIRTY = 0b11ULL << 13;
constexpr std::uint64_t MSTATUS_SD_MASK = 1ULL << 63;
...
public:
    ...
    std::uint64_t get_fpr(std::uint32_t index) const;
    void set_fpr(std::uint32_t index, std::uint32_t value);
